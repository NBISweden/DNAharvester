...
include { SAMTOOLS_FLAGSTAT as FLAGSTAT_MQ_FILTERED_BAM    } from '../../../modules/local/samtools/samtools_flagstat.nf'
include { MULTIQC as MULTIQC_MQ_FILTERED_BAM               } from '../../../modules/nf-core/multiqc/main'
include { SAMTOOLS_FLAGSTAT as FLAGSTAT_RM_SHORT_READS_BAM } from '../../../modules/local/samtools/samtools_flagstat.nf'
include { MULTIQC as MULTIQC_RM_SHORT_READS_BAM            } from '../../../modules/nf-core/multiqc/main'
include { SAMTOOLS_FLAGSTAT as FLAGSTAT_MERGED_BAM_LIB     } from '../../../modules/local/samtools/samtools_flagstat.nf'
...
include { SAMTOOLS_FLAGSTAT as FLAGSTAT_DEDUP_LIB          } from '../../../modules/local/samtools/samtools_flagstat.nf'
include { MULTIQC as MULTIQC_DEDUP_LIB                     } from '../../../modules/nf-core/multiqc/main'
include { SAMTOOLS_FLAGSTAT as FLAGSTAT_MERGED_BAM_SAMPLE  } from '../../../modules/local/samtools/samtools_flagstat.nf'
include { MULTIQC as MULTIQC_MERGED_BAM_SAMPLE             } from '../../../modules/nf-core/multiqc/main'
include { SAMTOOLS_FLAGSTAT as FLAGSTAT_DEDUP_SAMPLE       } from '../../../modules/local/samtools/samtools_flagstat.nf'
include { MULTIQC as MULTIQC_DEDUP_SAMPLE                  } from '../../../modules/nf-core/multiqc/main'
include { SAMTOOLS_DEPTH_MEAN                              } from '../../../modules/local/samtools/samtools_depth_mean.nf'
