...
include { SAMTOOLS_FAIDX as SAMTOOLS_FAIDX_COMPETITIVE   } from '../../../modules/local/samtools_faidx.nf'
include { FAI_TO_BED as FAI_TO_BED_COMPETITIVE           } from '../../../modules/local/fai2bed/main'
include { SAMTOOLS_FAIDX as SAMTOOLS_FAIDX_TARGET        } from '../../../modules/local/samtools_faidx.nf'
...
include { SAMTOOLS_VIEW_REGIONS as SAMTOOLS_VIEW_DECOY   } from '../../../modules/local/samtools_view_regions.nf'
include { SAMTOOLS_INDEX as SAMTOOLS_INDEX_DECOY         } from '../../../modules/nf-core/samtools/index/main'
include { SAMTOOLS_FLAGSTAT as FLAGSTAT_DECOY            } from '../../../modules/local/samtools_flagstat.nf'
include { MULTIQC as MULTIQC_DECOY                       } from '../../../modules/nf-core/multiqc/main'
include { SAMTOOLS_VIEW_REGIONS as SAMTOOLS_VIEW_TARGET  } from '../../../modules/local/samtools_view_regions.nf'
