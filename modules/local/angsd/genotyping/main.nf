process ANGSD_GENOTYPING {
    ...
    tuple val(meta), path("*.bamlist.txt")           , emit: bamlist
    tuple val(meta), path("*.geno.gz")               , emit: geno
    tuple val(meta), path("*.mafs.gz")               , emit: mafs
    tuple val(meta), path("*.beagle.gz")             , emit: beagle
